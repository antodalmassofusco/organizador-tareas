...
const TareaItem = ({ tarea, color, index, totalTareas, onCambiarEstado, onEliminar, onActualizar, onMoverArriba, onMoverAbajo }: TareaItemProps) => {
  ...
  return (
    <div className="rounded-xl border border-slate-100 hover:border-slate-200 hover:shadow-sm transition-all overflow-hidden" style={{ background: '#FFFDF5' }}>
      {/* Fila principal */}
            ...
            {editandoTitulo ? (
              <div className="space-y-2">
                <input
                  ...
                  maxLength={100}
                  className="w-full text-sm border border-slate-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500" style={{ background: '#FFFDF5' }}
                  autoFocus
                />
            ...
            {editandoDesc ? (
              <div className="space-y-2">
                <textarea
                  ...
                  rows={4}
                  className="w-full text-sm border border-slate-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none" style={{ background: '#FFFDF5' }}
                  autoFocus
                />
            ...
            {editandoFecha ? (
              <div className="flex gap-2 items-center">
                <input type="datetime-local" value={fecha} onChange={e => setFecha(e.target.value)}
                  className="text-sm border border-slate-200 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" style={{ background: '#FFFDF5' }} />
...
const DashboardPage = () => {
  ...
  return (
    <div className="min-h-screen p-6" style={{ background: '#FFFEF9' }}>
      <div className="flex h-[calc(100vh-48px)] overflow-hidden rounded-2xl shadow-sm" style={{ background: '#FFFDF5', border: '1px solid #E2E8F0' }}>
        <Sidebar
          carpetas={carpetas}
        ...
        <main className="flex-1 flex overflow-hidden relative">
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            {!carpetaSeleccionada ? (
              <div className="h-full flex items-center justify-center" style={{ background: '#FFFEF9' }}>
              ...
              <div className="flex-1 flex flex-col overflow-hidden" style={{ background: '#FFFEF9' }}>
                <div className="px-7 py-5 flex items-center gap-3" style={{ background: '#FFFDF5', borderBottom: '1px solid #E2E8F0' }}>
                ...
                <div className="flex-1 overflow-y-auto px-6 py-6 space-y-4">
                  <form onSubmit={handleCrearTarea} className="mb-4 rounded-xl p-5" style={{ background: '#FFFDF5', border: '1px solid #E2E8F0' }}>
                    <div className="flex flex-col gap-3 lg:flex-row">
                      <input
                        ...
                        style={{ border: '1px solid #E2E8F0', background: '#FFFEF9', color: '#0F172A' }}
                      />
                      <input
                        type="datetime-local"
                        ...
                        style={{ border: '1px solid #E2E8F0', background: '#FFFEF9', color: '#64748B' }}
                      ...
                      <button
                        ...
                        style={{ border: '1px solid #E2E8F0', color: '#64748B', background: '#FFFEF9' }}
                      >
                        Detalles
                      </button>
                      <button type="submit"
          ...
          <div
            ...
            style={{ background: '#FFFDF5', borderLeft: '1px solid #E2E8F0' }}
          >
            {carpetaSeleccionada ? (
              <>
                <div className="flex-1 flex flex-col overflow-hidden" style={{ borderBottom: '1px solid #E2E8F0' }}>
                  ...
                  <textarea
                    ...
                    style={{ color: '#0F172A', background: '#FFFDF5' }}
                  />
      ...
      {carpetaAEliminar && (
        ...
        >
          <div
            className="w-full max-w-md rounded-2xl border border-slate-100 p-7 shadow-2xl" style={{ background: '#FFFDF5' }}
      ...
      <div className="fixed bottom-10 right-10 z-50">
          {mostrarFAB && (
            <form onSubmit={handleCrearCarpetaFAB}
              ...
              style={{ background: '#FFFDF5', border: '1px solid #E2E8F0' }}>

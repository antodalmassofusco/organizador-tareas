...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-4" style={{ background: '#F7F8FA' }}>
      <div className="w-full max-w-md">
        {/* Logo */}
        <div className="flex justify-center mb-2">
          <img src="/logo-devtask.png" alt="DevTask" className="h-40 object-contain" />
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6" style={{ border: '1px solid #E2E8F0' }}>
          ...
          {error && (
            <div className="mb-4 px-4 py-2 rounded-lg text-sm" style={{ background: '#FEE2E2', border: '1px solid #FECACA', color: '#DC2626' }}>
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            {modo === 'registro' && (
              <div>
                <label className="text-sm font-medium block mb-1" style={{ color: '#0F172A' }}>Nombre</label>
                <div className="flex items-center px-3 py-2 rounded-lg border" style={{ borderColor: '#E2E8F0', background: '#F7F8FA' }}>
                  ...
                  <input
                    ...
                    required
                    className="flex-1 ml-2 text-sm focus:outline-none bg-transparent"
                    style={{ color: '#0F172A' }}
                  />
                </div>
              </div>
            ...
            <div>
              <label className="text-sm font-medium block mb-1" style={{ color: '#0F172A' }}>Contraseña</label>
              <div className="flex items-center px-3 py-2 rounded-lg border" style={{ borderColor: '#E2E8F0', background: '#F7F8FA' }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#94A3B8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {modo === 'registro' && (
              <div>
                <label className="text-sm font-medium block mb-1" style={{ color: '#0F172A' }}>Confirmar contraseña</label>
                <div className={`flex items-center px-3 py-2 rounded-lg border transition-colors ${
                ...
                {passwordConfirm && !passwordsMatch && (
                  <p className="text-xs mt-0.5" style={{ color: '#DC2626' }}>Las contraseñas no coinciden</p>
                )}
              </div>
            )}
            ...
            <button
              ...
              className="w-full font-semibold py-2 rounded-lg text-white transition-colors disabled:opacity-60"
